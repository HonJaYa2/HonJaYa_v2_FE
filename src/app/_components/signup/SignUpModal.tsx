...
import Step1 from '../../_components/signup/signupsteps/steps/Step1';
import Step2 from '../../_components/signup/signupsteps/steps/Step2';
import Step3 from '../../_components/signup/signupsteps/steps/Step3';
import Step4 from '../../_components/signup/signupsteps/steps/Step4';
...
//   },[]);
  ...
  return (
    <div className="z-20 w-full h-full flex justify-center items-center fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm">
      ...
      {step === 5 && <Step4 nextStep={nextStep} prevStep={prevStep} updateFormData={updateFormData} formData={formData} setOpenSignUpModal={() => setOpenSignUpModal} />}
    </div>
  );
}
